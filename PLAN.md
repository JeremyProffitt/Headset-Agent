...
- (marker `[~]` until: pipeline GREEN + live probes — payment solicitation blocked AND a planted off-KB/ungrounded answer rejected — via `aws bedrock-agent-runtime retrieve-and-generate`/`apply-guardrail --profile paul`.)
