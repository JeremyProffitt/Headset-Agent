...
- (marker `[~]` until: deploy re-ingests them + a `retrieve` probe for a mic query returns a `knowledge-base/microphone/*` doc AND the A-10 eval gate stays green with the new docs present.)
